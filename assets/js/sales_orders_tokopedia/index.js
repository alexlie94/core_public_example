...
function getChannel(data) {
  ...
  channel = channel_id;
  var url =
    base_url() + "sales_orders_tokopedia/get_data_status_order/" + channel_id;
  $.ajax({
    url: url,
    type: "GET",
    dataType: "html",
...
function getOrder(channel_id, order_status, limit, offset, filter) {
  ...
  var url = base_url() + "sales_orders_tokopedia/get_data_order";
...
function createShipment() {
  ...
  var url = base_url() + "sales_orders_tokopedia/add_create_shipment";
...
function sync_order(e) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      var url = base_url() + "sales_orders_tokopedia/sync_order";
