    ...
    public function index()
	{
		...
		$this->_custom_button_header = array(
			array(
				...
				'type' => 'modal',
				'fullscreen' => true,
				'url' => base_url() . "rolepermissions/insert",
			),
			array(
				'button' => 'import',
				'label' => 'Import Data Role',
				'type' => 'modal',
				'url' => base_url() . "rolepermissions/import",
			),
			array(
				'button' => 'export',
				'label' => 'Export Data Role',
				'type' => 'modal',
				'url' => base_url() . "rolepermissions/export",
			)
		);
		...
		$this->setJs('rolepermissions_admin');
	...
	public function show()
	{
		...
		$this->_custom_button_on_table = array(
			...
			array(
				...
				'url' => base_url() . "rolepermissions/delete/$1/$1",
			),
			array(
				'button' => 'status',
				'type' => 'confirm',
