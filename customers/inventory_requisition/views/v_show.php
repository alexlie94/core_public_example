							...
							<div class="row mb-10 mt-5">
								...
								<div class="col-md-7">
									<div class="d-flex flex-end gap-2 gap-lg-3 mt-9">
										<button type="button"
											class="btn btn-outline btn-outline-dashed btn-outline-warning hover-scale btn-active-light-warning btn-sm downloadView">
											<i class="fa-solid fa-cloud-download fs-4 me-2"></i>
											Download View
										</button>
										<button id="modal_master_data" data-fullscreenmodal="1" type="button"
											data-type="modal"
											data-url="<?= base_url('inventory_requisition/masterDataModal') ?> "
											data-fullscreenmodal="0"
											class="btn btn-outline btn-outline-dashed hover-scale btn-outline-primary btn-active-light-primary btn-sm fw-bold">
											<i class="fa-solid fa-clone fs-4 me-2"></i>
											Master Data
										</button>
										<button
											...
											data-url="<?= base_url('inventory_requisition/insert') ?> "
											data-fullscreenmodal="0">
						...
						<div class="row mb-5">
							<div class="d-flex flex-end gap-2 gap-lg-3">
								<button type="button" id="btnResetSearch"
									class="btn btn-outline btn-outline-dashed btn-outline-danger hover-scale btn-active-light-danger btn-sm fw-bold">
									<i class="fa-solid fa-refresh fs-4 me-2"></i>
									Reset
								</button>
