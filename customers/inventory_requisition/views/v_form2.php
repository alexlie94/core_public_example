    ...
    <div class="col-md-4">
        <div class="d-flex align-items-center mb-5">
            <div class="position-relative w-md-400px me-md-2">
                ...
                <input type="text" class="form-control form-control-solid ps-10" id="sku" placeholder="Find Product Name Or SKU" style="border: 2px solid #ccc;  border-radius: 10px;" />
            </div>
...
<table id="kt_datatable_sku" class="table table-striped table-row-bordered gy-5 gs-7">
    <thead>
