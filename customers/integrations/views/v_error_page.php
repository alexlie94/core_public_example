			...
			<div class="d-flex flex-column flex-center text-center p-10">
				...
				<div class="card card-flush w-lg-650px py-5">
					<div class="card-body py-15 py-lg-20">
						...
						<!--end::Logo-->
						<!--begin::Title-->
						<h1 class="fw-bolder text-gray-900 mb-5">Unable to integrate your account</h1>
						<!--end::Title-->
						<!--begin::Text-->

						<div class="fw-semibold fs-6 text-gray-500 mb-8">
							<?php
							if ($this->session->flashdata('msg_auth_error')) {
								echo $this->session->flashdata('msg_auth_error');
							} else {
								echo '
								Unfortunately, an error occurred while integrating your account. Please contact support.';
							}
							?>
						</div>
						<!--end::Text-->
						...
						<!--begin::Illustration-->
						<div class="mb-0">
							<img src="<?= MEDIA ?>/auth/404-error.png" class="mw-100 mh-300px theme-light-show"
								alt="" />
							<img src="<?= MEDIA ?>/auth/404-error-dark.png" class="mw-100 mh-300px theme-dark-show"
								alt="" />
						</div>
						<!--end::Illustration-->
					</div>
