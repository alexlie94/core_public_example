                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fs-6 fw-semibold text-gray-700">
                                ...
                                <a href="<?= base_url("sales_orders/detail/") . $row->id ?>">
                                    <?= $row->local_order_id ?>
                                </a>
                            </div>
                        </div>
                ...
                <div class=" d-flex align-items-right">
                    ...
                    <?php
						if ($row->local_order_status == 'READY_TO_SHIP') {
							...
							data-url="' . base_url() . 'sales_orders/form_create_shipment/' . $row->id . '">Create
							Shipment</button>
							';
							} else {
								echo '
                    ...
                    <?php
						if ($row->order_status_id == 3) {
							// echo '
							// <button type="button" class="btn btn-sm btn-primary" onclick="printLabel(this)" data-id="' . $row->local_order_id . '" >Print Label</button>
							// ';
							if ($row->shipping_label_status == 'READY') {
								echo '
								<a type="button" href="' . base_url() . 'sales_orders/print_label/' . $row->local_order_id . '" class="btn btn-sm btn-primary" onclick="printLabel()"  >Print Label</a>
								';
							} else {
								echo '
								<button type="button" class="btn btn-sm btn-secondary" disabled>
								Print Label not ready to print</button>
								';
							}
						}  ?>
