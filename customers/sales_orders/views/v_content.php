				...
				<div class="card-body pt-0 pb-0 ">
					<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
						<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold ">
							...
							?>
								<li class="nav-item ">
									<a class="nav-link text-active-primary ms-0 me-10 py-5 tabStatus <?= $active_status ? 'active' : '' ?>" data-bs-toggle="tab" data-id="<?= $status['status_code'] ?>" href="#" onclick="switch_status(this,<?= $row['id'] ?>)">
										<?= $status['status_name'] ?>
									</a>
								</li>
							<?php
				...
				<div class="tab-pane fade show active" role="tabpanel">
					<div class="d-flex flex-wrap flex-stack">
						...
						<div class="d-flex flex-wrap align-items-center  my-1">
							...
							<div class="d-flex align-items-center position-relative my-1">
								<select name="filter_select" id="filter_select" data-control="select2" data-hide-search="true" data-placeholder="Filter" class="form-select form-select-sm form-select-solid w-180px ">
									<option value="local_order_id" selected>Order ID</option>
									<option value="sku">SKU</option>
								</select>

								<div class="position-relative">
									<input type="text" id="filter_input" name="filter_input" class="form-control form-control-sm form-control-solid w-200px" placeholder="Search" />
							...
							<div class="d-flex my-0">
								<div class="mb-0">
									<div class="input-group">
										...
										<input class="form-control form-control-sm form-control-solid" placeholder="Pick date range" id="filter_date" />
					...
					-->
							<div class="d-flex  align-items-center position-relative ms-2 ">
								...
								<select name="filter_order_by" id="filter_order_by" data-control="select2" data-hide-search="true" data-placeholder="Filter" class="form-select form-select-sm  w-150px border-0 ms-2 ">
							...
							<div class="d-flex  align-items-center position-relative  ms-15">
								...
								<select name="filter_limit" id="filter_limit" data-control="select2" data-hide-search="true" data-placeholder="Filter" class="form-select form-select-sm  w-150px border-1 ms-2 ">
