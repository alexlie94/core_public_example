            ...
            <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack flex-wrap">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <h1
                            class="page-heading d-flex flex-column justify-content-center text-gray-400 fw-bold fs-1x m-0">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row g-5 g-xl-12">
                            ...
                            <div class="col-xl-12">
                                <!--begin::Notice-->
                                <div
                                    class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6 mb-4">
                                    <!--begin::Icon-->
                        ...
                        <div class="card shadow-sm mb-5 mb-xl-1">
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Inventory Storage Ready To
                                        Sale</span>
                                    <span
                                        class="text-gray-400 mt-1 fw-semibold fs-6"><?= isset($sumQty['total']) ? $sumQty['total'] : '0' ?>
                                        Pieces</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    ...
                                    <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                        ...
                                        <!--begin::Display range-->
                                        <div class="text-gray-600 fw-bold" id="search_by_date_range">Loading date
                                            range...</div>
                                        <!--end::Display range-->
                            ...
                            <div class="card-body py-3">
                                <!--begin::Datatable-->
                                <input type="hidden" name="paging_datatables" value="0" class="halaman"
                                    style="display: none"><input type="hidden" name="draw" value="1"
                                    class="draw_datatables" style="display: none">
                                <div class="table-responsive">
                                    <table id="dashboard_inventory" class="table table-hover table-rounded">
                                        <thead>
                                            <tr>
