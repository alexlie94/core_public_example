                    ...
                    <div class="card-body">
                        ...
                        <form id="formSearch" class="form formSearch" autocomplete="off">
                            <div class="row mb-10 mt-5">
                                ...
                                <div class="col-md-2">
                                    <label class="fs-5 fw-semibold mb-2">Filter</label>
                                    <select class="form-select" data-control="select2" name="searchBy" id="searchBy"
                                        aria-label="Please Select" data-type="select">
                                    ...
                                    <div class="d-flex gap-4 gap-lg-3 ml-4">
                                        ...
                                        foreach ($lookupValue as $result) {
                                            echo "	<div class='form-check form-check-custom form-check-success form-check-solid'>
												<input class='form-check' type='checkbox' id='lookup_status' name='lookup_status_{$no}' value='{$result->lookup_code}' data-type='checkbox' />
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col d-flex flex-column align-items-center justify-content-center">
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input class="form-control form-control-solid" placeholder="dd mm yyyy"
                                                    name="start_date" id="start_date" type="text" readonly="readonly"
                                                    data-type="input">
                                            </div>
                                        </div>
                                        ...
                                        <div class=" col d-flex flex-column align-items-center justify-content-center">
                                            <div class="input-group input-group-solid">
                                                <input class="form-control form-control-solid" placeholder="dd mm yyyy"
                                                    name="end_date" id="end_date" type="text" readonly="readonly"
                                                    data-type="input">
