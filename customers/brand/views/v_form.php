...
<div class="form-group row mb-8" id="show_mass_upload">
    ...
    <div class="col-md-5 mt-3">
        <a href="<?= base_url('/assets/excel/List_Brand.csv') ?>" download="List_Brand.csv" target="_blank"
            class="text-gray-800 text-hover-primary d-flex flex-column mb-3 text-center">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="fv-row mb-7">
                    <label class="fw-semibold fs-6 mb-4">Brand Code</label>
                    <input type="text" id="brand_code" name="brand_code" class="form-control form-control mb-3 mb-lg-0"
                        placeholder="Brand Code" value="<?= isset($brand_code) ? $brand_code : 'Auto' ?>"
            ...
            <div class="col-md-6">
                <div class="fv-row mb-7">
                    ...
                    <input type="text" id="brand_name" name="brand_name" class="form-control form-control mb-3 mb-lg-0"
                        placeholder="Brand Name" value="<?= isset($brand_name) ? $brand_name : '' ?>" data-type="input"
                        autocomplete="off" />
                </div>
            </div>
            <div class="col-md-12">
                <div class="fv-row mb-7">
                    ...
                    <textarea type="text" id="desc" name="desc" class="form-control form-control mb-3 mb-lg-0" rows="4"
                        placeholder="Description" data-type="input"
                        autocomplete="off"><?= isset($description) ? $description : '' ?></textarea>
                </div>
            </div>
        </div>
    </div>
