...
class Menu_model extends MY_ModelCustomer
{
    use MY_Tables;

    public function __construct()
    {
        $this->_tabel = $this->_table_users_ms_menus;
        parent::__construct();
    }
    ...
    public function getMenu()
    {
        $this->db->select('a.id,
            ...
            b.import,
            b.export',FALSE);
        $this->db->join("{$this->_table_users_ms_accesscontrols} b","b.{$this->_tabel}_id = a.id","inner");
    ...
    public function getSpecificMenu($array)
    {
        $this->db->where($array);
        $this->db->limit(1);
