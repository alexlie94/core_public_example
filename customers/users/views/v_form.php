...
<div class="d-flex flex-column scroll-y me-n7 pe-7">
    ...
    <div class="fv-row mb-7">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <input type="text" id="fullname" name="fullname" class="form-control  mb-3 mb-lg-0" placeholder="Full name"
            value="<?= isset($fullname) ? $fullname : "" ?>" data-type="input" autocomplete="off" />
        <!--end::Input-->
    </div>
    <!--end::Input group-->
    <!--begin::Input group-->
    <div class="fv-row mb-7">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <input type="text" class="form-control  mb-3 mb-lg-0" placeholder="example@domain.com" id="email" name="email"
            value="<?= isset($email) ? $email : '' ?>" data-type="input" autocomplete="off" />
        <!--end::Input-->
    </div>
    <!--end::Input group-->
    <!--begin::Input group-->
    <div class="fv-row mb-7">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <input type="text" class="form-control  mb-3 mb-lg-0" placeholder="password" id="password" name="password"
    ...
    <div class="mb-7">
        ...
        foreach ($role as $ky => $val) {
            ...
            $output .= '<div class="form-check form-check-custom ">';
