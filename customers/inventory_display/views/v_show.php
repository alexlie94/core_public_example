								...
								<div class="col-md-5 mt-9 flex-end d-flex align-items-center">
									<div class="d-flex flex-end gap-2 gap-lg-3">
										<button
											...
											id="btnMassUpload" data-type="modal"
											data-url="<?= base_url('inventory_display/upload') ?>" type="button">
										...
										<button
											...
											id="btnExport" data-type="redirect"
											data-url="<?= base_url('inventory_display/download'); ?>" type="button">
						...
						<div class="row mb-5">
							<div class="d-flex flex-end gap-2 gap-lg-3">
								<button
									...
									onclick="reloadDatatables()" type="button">
									<i class="fa-solid fa-search fs-4 me-2"></i>Search</button>
								<button id="btnSearchResetInventory"
