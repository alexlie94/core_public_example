                        ...
                        <form id="formSearch" class="form formSearch" autocomplete="off">
                            <div class="row mb-10 mt-5">
                                ...
                                <div class="col-md-3" id="select_batch_location">
                                    <select name="batch_location" id="batch_location" class="form-select mt-9"
                                        data-control="select2" data-hide-search="true" data-type='select2'
                                        data-placeholder="Select Batch Location">
                                        <option value="" disabled selected hidden>Please Select</option>
                                        <option value="99">Main</option>
                                ...
                                <div class="col">
                                    <div class="d-flex flex-end gap-2 gap-lg-3 mt-9">
                                        <button
                                            ...
                                            data-url="<?= base_url() . "product_prices/download_view" ?>">
                                        ...
                                        <button
                                            ...
                                            data-url="<?= base_url() . "product_prices/insert" ?>"
