...
<div class="card card-bordered mb-5 groupCard border border-dark" style="padding: 20px;">
    <form id="formSearch" class="form formSearch" autocomplete="off"
        data-url="<?= base_url() . 'inventory_warehouse/exports_picking' ?>">
        <div class="row mb-4 mt-5">
            ...
            <div class="col-md-6 fv-row">
                ...
                <select name="status_id" id="status_id" class="form-select form-select-solid" data-control="select2"
        ...
        <div class="row mb-4" id="search_created_at">
            ...
            <div class="col-md-6 fv-row">
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <input class="form-control form-control-solid ps-12 flatpickr-input active"
                        placeholder="Select a date" name="from_val" type="text" readonly="readonly" id="kt_datepicker_3"
                        data-type="input">
                    <!--end::Datepicker-->
                </div>
            </div>
            <div class="col-md-6 fv-row">
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <!--begin::Datepicker-->
                    <input class="form-control form-control-solid ps-12 flatpickr-input active"
                        placeholder="Select a date" name="to_val" type="text" readonly="readonly" id="kt_datepicker_4"
                        data-type="input">
                    <!--end::Datepicker-->
                </div>
            </div>
...
<div class="table-responsive">
    <table id="show_picking" class="table table-hover table-rounded">
        <thead>
            <tr>
                ...
                <th class="min-w-150px">Quantity Picking</th>
