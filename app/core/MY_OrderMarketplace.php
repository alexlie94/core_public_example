...
class MY_OrderMarketplace extends CI_Model
{
	protected $_ci;
	...
	public function change_status_auth_when_error($auth_id, $update)
	{
		...
		$this->db->update('users_ms_authenticate_channels', $auth_change);
	...
	function insert_order($data)
	{
		...
		try {
			...
			if (!$check_order) {
				$trx_number = mkautono_no_auth('users_tr_orders', 'trx_number', 'SO', $data['users_ms_companys_id']);
