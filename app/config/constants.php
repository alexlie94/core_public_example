...
define('LOGIN', 'login');
define('BASE_URL', (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . '/ims_project/');
...
define('LOGIN_CUSTOMER_FILE', 'js-core/logincustomer.js');
define('LOGIN_OWNER_FILE', 'js-core/loginowner.js');

define('JS_GENERAL', BASE_URL . ASSETSGENERAL . '/' . GENERAL_FILE);
define('JS_LOGIN_CUSTOMER', BASE_URL . ASSETSGENERAL . '/' . LOGIN_CUSTOMER_FILE);
define('JS_LOGIN_OWNER', BASE_URL . ASSETSGENERAL . '/' . LOGIN_OWNER_FILE);
