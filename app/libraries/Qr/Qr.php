...
class Qr
{
	...
	public function render($text, $par1 = '', $par2 = '', $par3 = '', $par4 = '', $par5 = '', $par6 = '', $par7 = '', $par8 = '')
	{
		$path       = APPPATH . "libraries/Qr/data";
		$image_path = APPPATH . "libraries/Qr/image";

		$version_ul = 40;

		$qrcode_data_string     = $text;
		$qrcode_error_correct   = $par1;
		$qrcode_module_size     = $par2;
		$qrcode_version         = $par3;
		$qrcode_image_type      = $par4;

		$qrcode_structureappend_n           = $par5;
		$qrcode_structureappend_m           = $par6;
		$qrcode_structureappend_parity      = $par7;
		$qrcode_structureappend_originaldata = $par8;
		...
		// echo "<PRE>";print_r(array($data_value, $data_counter, $data_value, $data_bits, $codeword_num_counter_value, $total_data_bits, $max_data_bits));exit;
		...
		// echo "<PRE>";print_r($max_codewords);exit;
		...
		// echo "<PRE>";print_r($codewords);exit;
		if ($codewords_counter < $max_data_codewords - 1) {
			$flag = 1;
        ...
        */
		...
		// echo "<pre>";print_r($matrix_content[20]);exit;
